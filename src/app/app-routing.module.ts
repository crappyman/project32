...
import { ResetPageComponent } from './users/resetPassword/reset-page/reset-page.component';
import { ResetPageEmailComponent } from './users/resetPassword/reset-page-email/reset-page-email.component';
...
const routes: Routes = [
  ...
  { path: "reset-email-page", component: ResetPageEmailComponent},
];
